...
QT_MOC_LITERAL(1, 8, 14), // "folderSelected"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 10), // "foldername"
QT_MOC_LITERAL(4, 35, 18), // "folderReadFinished"
QT_MOC_LITERAL(5, 54, 15), // "QList<Folder*>*"
QT_MOC_LITERAL(6, 70, 7) // "folders"

    },
    "Account\0folderSelected\0\0foldername\0"
    "folderReadFinished\0QList<Folder*>*\0"
    "folders"
};
...
void Account::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->folderSelected((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->folderReadFinished((*reinterpret_cast< QList<Folder*>*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Account::folderSelected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Account::*)(QList<Folder*> * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Account::folderReadFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Account::folderSelected(QString _t1)
{
...
// SIGNAL 1
void Account::folderReadFinished(QList<Folder*> * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
