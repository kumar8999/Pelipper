...
QT_MOC_LITERAL(1, 12, 19), // "foldersLoadFinished"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 21), // "onFoldersReadFinished"
QT_MOC_LITERAL(4, 55, 15), // "QList<Folder*>*"
QT_MOC_LITERAL(5, 71, 10) // "folderList"

    },
    "AccountItem\0foldersLoadFinished\0\0"
    "onFoldersReadFinished\0QList<Folder*>*\0"
    "folderList"
};
...
void AccountItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->foldersLoadFinished(); break;
        case 1: _t->onFoldersReadFinished((*reinterpret_cast< QList<Folder*>*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AccountItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AccountItem::foldersLoadFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AccountItem::foldersLoadFinished()
{
