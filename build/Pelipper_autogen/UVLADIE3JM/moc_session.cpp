...
QT_MOC_LITERAL(1, 8, 12), // "accountAdded"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8), // "Account*"
QT_MOC_LITERAL(4, 31, 7), // "account"
QT_MOC_LITERAL(5, 39, 14) // "accountRemoved"

    },
    "Session\0accountAdded\0\0Account*\0account\0"
    "accountRemoved"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->accountAdded((*reinterpret_cast< Account*(*)>(_a[1]))); break;
        case 1: _t->accountRemoved((*reinterpret_cast< Account*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Session::*)(Account * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::accountAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Session::*)(Account * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::accountRemoved)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Session::accountAdded(Account * _t1)
{
...
// SIGNAL 1
void Session::accountRemoved(Account * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
